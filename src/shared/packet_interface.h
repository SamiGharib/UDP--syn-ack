...
/*
 * Décode des données reÃ§ues et crée une nouvelle structure pkt.
 * Le paquet reÃ§u est en network byte-order.
 * La fonction vérifie que:
 * - Le CRC32 des données reÃ§ues est le mÃªme que celui décodé Ã  la fin
 *   du flux de données
 ...
 * @post: pkt est la représentation du paquet reÃ§u
 *
